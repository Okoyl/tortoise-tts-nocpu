...
Tortoise-tts by neonbjb an amazing work, I view it as the best TTS engine created.
I forked the project to do some changes, The original code wastes a lot of time transfering data between CPU and the GPU. here I tried to minimize it to the best of my knowledge.
